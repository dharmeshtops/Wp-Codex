...
function sa_register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'slug' => 'js_composer_theme',  // The plugin parent_slug
            'source' => THEME_FRAMEWORK. '/plugins/js_composer.zip',  // The plugin source
        ...
        /*array(
            ...
            'slug' => 'wordpress-seo',  // The plugin parent_slug
            'source' => 'http://downloads.wordpress.org/plugin/wordpress-seo.latest-stable.zip',  // The plugin source
            'required' => true,  // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name' => 'respacio',   // The plugin name
            'slug' => 'respacio',  // The plugin parent_slug
            'source' => THEME_FRAMEWORK. '/plugins/respacio.zip',  // The plugin source
            'required' => true,  // If false, the plugin is only 'recommended' instead of required
